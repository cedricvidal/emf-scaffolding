...
public class BusinessPackageImpl extends EPackageImpl implements BusinessPackage {
	 ...
	 * @see org.eclipselabs.emf.scaffolding.demos.businessapp.business.BusinessPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EReference getDAO_Method() {
	 ...
	 * @generated
	 */
	public EReference getApplication_Element() {
	 ...
	 * @generated
	 */
	public EReference getApplication_DefaultIdentifierType() {
	 ...
	 * @generated
	 */
	public EReference getElement_Application() {
	 ...
	 * @generated
	 */
	public EReference getService_Dependency() {
	...
	public void createPackageContents() {
		...
		createEReference(daoEClass, DAO__METHOD);
		...
		createEReference(applicationEClass, APPLICATION__ELEMENT);
		createEReference(applicationEClass, APPLICATION__DEFAULT_IDENTIFIER_TYPE);

		elementEClass = createEClass(ELEMENT);
		createEReference(elementEClass, ELEMENT__APPLICATION);
		...
		createEReference(serviceEClass, SERVICE__DEPENDENCY);
	...
	public void initializePackageContents() {
		...
		initEClass(daoEClass, org.eclipselabs.emf.scaffolding.demos.businessapp.business.DAO.class, "DAO", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getDAO_Entity(), this.getEntity(), null, "entity", null, 0, 1, org.eclipselabs.emf.scaffolding.demos.businessapp.business.DAO.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getDAO_Method(), this.getMethod(), null, "method", null, 0, -1, org.eclipselabs.emf.scaffolding.demos.businessapp.business.DAO.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getAttribute_Type(), this.getPrimitiveType(), null, "type", null, 0, 1, Attribute.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(applicationEClass, Application.class, "Application", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getApplication_Element(), this.getElement(), this.getElement_Application(), "element", null, 0, -1, Application.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getApplication_DefaultIdentifierType(), this.getPrimitiveType(), null, "defaultIdentifierType", null, 1, 1, Application.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(elementEClass, Element.class, "Element", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getElement_Application(), this.getApplication(), this.getApplication_Element(), "application", null, 0, 1, Element.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getService_Dependency(), this.getComponent(), null, "dependency", null, 0, -1, Service.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
