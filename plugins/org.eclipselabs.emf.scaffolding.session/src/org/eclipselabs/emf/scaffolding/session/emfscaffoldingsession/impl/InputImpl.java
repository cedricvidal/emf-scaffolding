 ...
 * <ul>
 *   <li>{@link org.eclipselabs.emf.scaffolding.session.emfscaffoldingsession.impl.InputImpl#getModel <em>Model</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class InputImpl extends EObjectImpl implements Input {
	...
	protected EClass eStaticClass() {
		return EMFScaffoldingSessionPackage.Literals.INPUT;
	}
		...
		if (model != null && model.eIsProxy()) {
			...
			if (model != oldModel) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, EMFScaffoldingSessionPackage.INPUT__MODEL, oldModel, model));
			}
		}
		return model;
	}
	...
	public void setModel(EObject newModel) {
		...
		model = newModel;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EMFScaffoldingSessionPackage.INPUT__MODEL, oldModel, model));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EMFScaffoldingSessionPackage.INPUT__MODEL:
