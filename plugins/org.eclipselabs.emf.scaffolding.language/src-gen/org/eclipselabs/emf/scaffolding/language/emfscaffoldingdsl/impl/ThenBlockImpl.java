 ...
 * <ul>
 *   <li>{@link org.eclipselabs.emf.scaffolding.language.emfscaffoldingdsl.impl.ThenBlockImpl#getStatements <em>Statements</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ThenBlockImpl extends MinimalEObjectImpl.Container implements ThenBlock
{
  ...
  {
    return EmfscaffoldingdslPackage.Literals.THEN_BLOCK;
  }
  ...
  public EList<Statement> getStatements()
  {
    if (statements == null)
    {
      statements = new EObjectContainmentEList<Statement>(Statement.class, this, EmfscaffoldingdslPackage.THEN_BLOCK__STATEMENTS);
    }
    return statements;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case EmfscaffoldingdslPackage.THEN_BLOCK__STATEMENTS:
