 ...
 * <ul>
 *   <li>{@link org.eclipselabs.emf.scaffolding.language.emfscaffoldingdsl.impl.ListLiteralImpl#getItems <em>Items</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ListLiteralImpl extends ExpressionImpl implements ListLiteral
{
   ...
   * @ordered
   */
  protected EList<Expression> items;
  ...
  {
    return EmfscaffoldingdslPackage.Literals.LIST_LITERAL;
  }
   ...
   * @generated
   */
  public EList<Expression> getItems()
  {
    if (items == null)
    {
      items = new EObjectContainmentEList<Expression>(Expression.class, this, EmfscaffoldingdslPackage.LIST_LITERAL__ITEMS);
    }
    return items;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case EmfscaffoldingdslPackage.LIST_LITERAL__ITEMS:
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      case EmfscaffoldingdslPackage.LIST_LITERAL__ITEMS:
        getItems().clear();
        getItems().addAll((Collection<? extends Expression>)newValue);
        return;
    }
