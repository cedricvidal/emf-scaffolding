 ...
 * <ul>
 *   <li>{@link org.eclipselabs.emf.scaffolding.tests.model1.impl.ApplicationImpl#getElements <em>Elements</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ApplicationImpl extends EObjectImpl implements Application {
	...
	protected EClass eStaticClass() {
		return Model1Package.Literals.APPLICATION;
	}
	...
	public EList<ApplicationElement> getElements() {
		if (elements == null) {
			elements = new EObjectContainmentWithInverseEList<ApplicationElement>(ApplicationElement.class, this, Model1Package.APPLICATION__ELEMENTS, Model1Package.APPLICATION_ELEMENT__APPLICATION);
		}
		return elements;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Model1Package.APPLICATION__ELEMENTS:
