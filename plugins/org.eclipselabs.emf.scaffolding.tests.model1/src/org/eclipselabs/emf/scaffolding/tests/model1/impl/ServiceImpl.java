 ...
 * <ul>
 *   <li>{@link org.eclipselabs.emf.scaffolding.tests.model1.impl.ServiceImpl#getDependencies <em>Dependencies</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ServiceImpl extends ComponentImpl implements Service {
	...
	protected EClass eStaticClass() {
		return Model1Package.Literals.SERVICE;
	}
	...
	public EList<Component> getDependencies() {
		if (dependencies == null) {
			dependencies = new EObjectResolvingEList<Component>(Component.class, this, Model1Package.SERVICE__DEPENDENCIES);
		}
		return dependencies;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Model1Package.SERVICE__DEPENDENCIES:
