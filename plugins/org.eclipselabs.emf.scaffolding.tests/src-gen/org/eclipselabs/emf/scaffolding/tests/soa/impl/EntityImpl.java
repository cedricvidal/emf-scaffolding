 ...
 * <ul>
 *   <li>{@link org.eclipselabs.emf.scaffolding.tests.soa.impl.EntityImpl#getAttributes <em>Attributes</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EntityImpl extends TypeImpl implements Entity {
	...
	public EList<Attribute> getAttributes() {
		if (attributes == null) {
			attributes = new EObjectContainmentEList<Attribute>(Attribute.class, this, SoaPackage.ENTITY__ATTRIBUTES);
		}
		return attributes;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SoaPackage.ENTITY__ATTRIBUTES:
