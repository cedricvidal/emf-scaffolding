...
/**
 * This is the item provider adapter for a {@link org.eclipselabs.emf.scaffolding.session.emfscaffoldingsession.Input} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InputItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Input_model_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Input_model_feature", "_UI_Input_type"),
	...
	public String getText(Object object) {
		String string = getString("_UI_Input_type");
		Input input = (Input) object;
		if(input.getModel() != null && input.getModel().eResource() != null) {
			String path = input.getModel().eResource().getURI().toString();
			string += " - " + path;
		}
		return string;
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EMFScaffoldingSessionPackage.Literals.INPUT__MODEL);
		}
