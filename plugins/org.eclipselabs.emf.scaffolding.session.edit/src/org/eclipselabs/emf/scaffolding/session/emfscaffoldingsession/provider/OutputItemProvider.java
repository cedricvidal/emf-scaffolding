...
/**
 * This is the item provider adapter for a {@link org.eclipselabs.emf.scaffolding.session.emfscaffoldingsession.Output} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OutputItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EMFScaffoldingSessionPackage.Literals.OUTPUT__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EMFScaffoldingSessionPackage.Literals.OUTPUT__ELEMENTS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Output.class)) {
			case EMFScaffoldingSessionPackage.OUTPUT__NAME:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case EMFScaffoldingSessionPackage.OUTPUT__ELEMENTS:
